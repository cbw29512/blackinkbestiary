...
def audit_active_book(root: Path) -> dict:
    ...
    for label in ("manifest", "state", "quality_rules", "page_archetypes", "environment_standard", "coloring_page_standard", "universal_page_contract", "universal_monster_contract", "universal_environment_contract", "universal_story_contract", "kdp_print_standard", "content_scope"):
        path = paths[label]
