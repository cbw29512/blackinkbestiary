...
try:
    from .equipment_attachments import attachment_prompt_sections, attachment_review_checks
...
def build_prompt(page: dict, review_notes: dict | None = None) -> str:
    ...
    sections = [
        ...
        *attachment_prompt_sections(spec, ROOT),
        (
...
def build_supervisor_checklist(page: dict) -> list[str]:
    ...
    checks.extend(attachment_review_checks(spec, ROOT))
